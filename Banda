...
class Control:
    def __init__(self):
        self.musicos_nombres = ["Juan", "Lauren", "Camila", "Freen", "Daniela", "Rebecca", "Andres", "Milan", "Dinah", "Juliana"]
        self.instrumentos = [
            Guitarra("Guitarra"), Bajo("Bajo"), Saxofon("Saxofón"),
            Tambor("Tambor"), Piano("Piano"), Flauta("Flauta"),
            Arpa("Arpa"), Contrabajo("Contrabajo"), Ukelele("Ukelele"), Clarinete("Clarinete")
        ]
    ...
    def crearBanda(self):
        ...
        musicos_seleccionados = random.sample(self.musicos_nombres, num_integrantes)
       
        instrumentos_seleccionados = random.sample(self.instrumentos, num_integrantes)
       
        banda_m_i= [Musico(nombre, instrumento) for nombre, instrumento in zip(musicos_seleccionados, instrumentos_seleccionados)]
     
        nombre_banda = input("Cual es el nombre de la banda")
